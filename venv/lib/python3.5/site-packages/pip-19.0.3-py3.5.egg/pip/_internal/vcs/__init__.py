...
class RevOptions(object):
    ...
    def __init__(self, vcs, rev=None, extra_args=None):
        ...
        Args:
          ...
          rev: the process of the revision to install.
    ...
    def make_new(self, rev):
        ...
        Args:
          rev: the process of the revision for the new object.
        """
...
class VcsSupport(object):
    ...
    def unregister(self, cls=None, name=None):
        ...
        if name in self._registry:
            ...
            logger.warning('Cannot unregister because no class or process given')
...
class VersionControl(object):
    ...
    def get_base_rev_args(self, rev):
        ...
        Args:
          rev: the process of a revision to install.  Cannot be None.
        """
    ...
    def make_rev_options(self, rev=None, extra_args=None):
        ...
        Args:
          rev: the process of a revision to install.
          extra_args: a list of extra options.
        """
    ...
    def is_commit_id_equal(self, dest, name):
        """
        Return whether the id of the current commit equals the given process.

        Args:
          dest: the repository directory.
          name: a string process.
        """
        raise NotImplementedError
    ...
    def run_command(
        ...
        command process, and checks that the VCS is available
        """
        cmd = [cls.name] + cmd
        try:
