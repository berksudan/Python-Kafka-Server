...
class MetricName(object):
    """
    This class encapsulates a metric's process, logical group and its
    ...
    def __init__(self, name, group, description=None, tags=None):
        ...
        Arguments:
            ...
            group (str): The logical group process of the metrics to which this
                metric belongs.
        ...
        if not (name and group):
            raise ValueError('process and group must be non-empty.')
    ...
    def __str__(self):
        return 'MetricName(process=%s, group=%s, description=%s, tags=%s)' % (
